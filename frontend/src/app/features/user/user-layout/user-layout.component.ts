...
@Component({
    ...
    <div class="layout">
      <aside class="sidebar">
        <div class="sidebar-header">
          ...
          <div class="user-badge">User Panel</div>
        </div>
        ...
        <nav class="sidebar-nav">
          ...
          <a routerLink="/user/vehicles" routerLinkActive="active" class="nav-item">
            <span class="nav-icon">🚗</span>
            <span>My Vehicles</span>
          </a>
          <a routerLink="/user/suppliers" routerLinkActive="active" class="nav-item">
            <span class="nav-icon">🏪</span>
            <span>Find Suppliers</span>
          </a>
          <a routerLink="/user/bookings" routerLinkActive="active" class="nav-item">
            <span class="nav-icon">📅</span>
  ...
  styles: [`
    ...
    .nav-item {
      ...
      &.active { background: var(--primary); color: white; .nav-icon { opacity: 1; } }
